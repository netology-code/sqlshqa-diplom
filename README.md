...
2. Скачайте базу данных для выполнения итоговой работы [по ссылке](https://github.com/netology-code/sqlshqa-diplom/releases). База данных находится в релизах этого репозитория, залогиньтесь в GitHub, чтобы получить доступ к скачиванию.
